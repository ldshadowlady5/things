...
public final class ThingsBlocks {
    ...
    public static final RegistryObject<BlockCymbal> CYMBAL = REG.register("cymbal", () -> new BlockCymbal(Block.Properties.create(Material.MISCELLANEOUS).lightValue(10).sound(SoundType.WOOD)));
    ...
    public static final RegistryObject<BlockCrashCymbal> CRASH_CYMBAL = REG.register("crash_cymbal", () -> new BlockCrashCymbal(Block.Properties.create(Material.MISCELLANEOUS).lightValue(10).sound(SoundType.WOOD), Block.makeCuboidShape(2.0D, 0.0D, 2.0D, 14.0D, 16.0D, 14.0D)));
    public static final RegistryObject<BlockKeyboard> KEYBOARD = REG.register("keyboard", () -> new BlockKeyboard(Block.Properties.create(Material.MISCELLANEOUS).hardnessAndResistance(0.1F).lightValue(10).sound(SoundType.WOOD), Block.makeCuboidShape(0.0D, 0.0D, 5.0D, 16.0D, 3.0D, 12.0D)));
