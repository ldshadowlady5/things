...
public class BlockBigDrum extends HorizontalBlock {
    ...
    public BlockBigDrum(Properties properties, VoxelShape ShapeIn) {
        super(properties);
    ...
    protected void playSound(@Nullable PlayerEntity player, IWorld world, BlockPos pos) {
        world.playSound(player, pos, SoundList.BIG_DRUM_SOUND.get(), SoundCategory.BLOCKS, 1F, 1F);
    }
